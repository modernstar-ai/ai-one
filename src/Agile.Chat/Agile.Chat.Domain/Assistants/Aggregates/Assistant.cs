...
{
    [JsonConstructor]
    private Assistant(string name, string description, AssistantStatus status, string greeting, AssistantFilterOptions filterOptions, AssistantPromptOptions promptOptions)
    {
    ...
    {
        return new Assistant(name, description, status, greeting, filterOptions, promptOptions);
    }
