...
public static class Configs
{
    ...
    public static AzureDocumentIntelligence AzureDocumentIntelligence => config.GetSection("AzureDocumentIntelligence").Get<AzureDocumentIntelligence>()! ?? throw new NullReferenceException("AzureDocumentIntelligence is null");
