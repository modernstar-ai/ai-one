          ...
          <main className="flex-1 space-y-6">
            ...
            <Card>
              ...
              <CardContent className="flex flex-wrap gap-4">
                <Button className="bg-black text-white hover:bg-gray-800 h-12" onClick={handleConnectDatabase}>
                  Connect to Database
                </Button>
                <Button className="bg-black text-white hover:bg-gray-800 h-12" onClick={handleConnectLogicApp}>
                  Connect to Logic App
                </Button>
                <Button className="bg-black text-white hover:bg-gray-800 h-12" onClick={handleConnectExternalAPI}>
