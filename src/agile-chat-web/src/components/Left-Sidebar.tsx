                        ...
                        <div className="flex h-full border-green-500 border-1">
                            ...
                            <div className="w-16 bg-primary text-primary-foreground flex flex-col items-center py-4 space-y-4">
                                ...
                                <div className="flex-grow flex flex-col justify-center space-y-4">
                                    ...
                                    <Link to="/tools" aria-label="Tools" accessKey="l"><Button variant="ghost" size="icon" tabIndex={-1} aria-label="Tools Page Button"><Wrench className="h-6 w-6" /></Button></Link> 
                                </div>
